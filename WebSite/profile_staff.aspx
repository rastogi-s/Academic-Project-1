<%@ Page Title="" Language="C#" MasterPageFile="~/childmasterStaff.master" AutoEventWireup="true" CodeFile="profile_staff.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
         ...
         <table style="width: 101%; height:1384px; color: #FFFFFF;" bgcolor="White">
       
        <tr>
           
            <td  bgcolor="White" colspan="2" class="style43" align="center" >
                 <strong style="color: #000000; text-align: center;"><span class="style102">Staff&#39;s Profile</span></strong></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td class="style30" bgcolor="#B50D0D" style="padding-left:20px;">
                <textarea id="TextArea1" name="S1" cols=20 rows=10 runat=server ></textarea></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td class="style39" bgcolor="#B50D0D">
                &nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;<asp:TextBox ID="TextBox34" runat="server" Height="29px" Width="198px"></asp:TextBox>
