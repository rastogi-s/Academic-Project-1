<%@ Page Title="" Language="C#" MasterPageFile="~/childmasterStaff.master" AutoEventWireup="true" CodeFile="StaffUpdateApply.aspx.cs" Inherits="_Default" %>
    ...
    bgcolor="White">
        ...
        <tr>
            ...
            <td  bgcolor="White" colspan="2" class="style43" align="center" >
                 &nbsp;<strong style="color: #000000; text-align: center;"><span class="style29">Staff&#39;s Profile</span></strong></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;<asp:CompareValidator ID="CompareValidator6" runat="server" 
        ...
        <tr>
            ...
            <td class="style47" bgcolor="#B50D0D">
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="TextBox34" runat="server" Height="27px" Width="100px"></asp:TextBox>
                <asp:CalendarExtender ID="TextBox34_CalendarExtender" runat="server" 
                    TargetControlID="TextBox34" OnClientShown="ChangeCalendarView" >
                </asp:CalendarExtender>
                &nbsp;&nbsp;
                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                    ErrorMessage="(Field cannot be empty)" ValidationGroup="g" 
                    ControlToValidate="TextBox34"></asp:RequiredFieldValidator>
                </td>
        ...
        <tr>
            ...
            <td class="style205" bgcolor="#B50D0D">
                &nbsp;&nbsp;* Qualification :&nbsp;</td>
            <td class="style205" bgcolor="#B50D0D">
                &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td  bgcolor="#B50D0D" colspan="2" class="style204" style="text-align: center">
