<%@ Page Title="" Language="C#" MasterPageFile="~/childmasterStaff.master" AutoEventWireup="true" CodeFile="FacultyManager_homepage.aspx.cs" Inherits="_Default" %>
    ...
    <table style="width: 100%; height: 557px;">
        ...
        <tr>
            ...
            <td class="style72" bgcolor="#B50D0D">
                <span class="style68">&nbsp;&nbsp;&nbsp; <span class="style77">Department Name</span> :</span></td>
        ...
        <tr>
            <td class="style76" colspan="5">
                <asp:Button ID="Button1" runat="server" Text="Register Faculty" Width="135px" 
                    onclick="Button1_Click" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button3" runat="server" 
                    onclick="Button3_Click" Text="Class Allotment" Width="145px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button4" runat="server" Text="Course Allotment" Width="145px" 
                    onclick="Button4_Click" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button2" runat="server" Text="Edit Faculty Details " 
