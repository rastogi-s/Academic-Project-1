<%@ Page Title="" Language="C#" MasterPageFile="~/childmasterStaff.master" AutoEventWireup="true" CodeFile="Add_new_sec.aspx.cs" Inherits="_Default" %>
                ...
                <table style="width: 678px; height: 286px;  " 
                    ...
                    <tr>
                        <td class="style207">
                            ...
                            &nbsp;Class:</span></strong></td>
                        <td class="style208">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="TextBox1" runat="server" Height="21px" Width="97px" 
                                ></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;
                            </td>
                    </tr>
                    <tr>
                        ...
                        <td class="style206">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="TextBox2" runat="server" Height="21px" Width="97px" 
                                ></asp:TextBox>
                            &nbsp;&nbsp;&nbsp;
                            </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align: center" class="style52" >
                            <asp:Button ID="Button1" runat="server" Height="24px" 
                                Text="ADD" Width="92px" ValidationGroup="Not_empty" 
