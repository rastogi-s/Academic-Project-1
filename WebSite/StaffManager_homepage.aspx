<%@ Page Title="" Language="C#" MasterPageFile="~/childmasterStaff.master" AutoEventWireup="true" CodeFile="StaffManager_homepage.aspx.cs" Inherits="_Default" %>
    ...
    <table style="width: 100%; height: 557px;">
        ...
        <tr>
            ...
            <td class="style72" bgcolor="#B50D0D">
                &nbsp;&nbsp;&nbsp; <span class="style77">Department Name</span> : </td>
        ...
        <tr>
            <td class="style76" colspan="5">
                <asp:Button ID="Button1" runat="server" Text="Register Staff" Width="135px" 
                    onclick="Button1_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button2" runat="server" Text="Edit Staff Details " 
